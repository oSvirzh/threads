 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.threads.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.threads'; // ios bundle id
const PACKAGE = 'com.threads'; // android package name
const NAME = 'threads'; // app name
const EXPO_ACCOUNT_OWNER = 'osvirzh'; // expo account owner
const EAS_PROJECT_ID = 'e782de20-5e10-4d1d-8914-394b2a63fd43'; // eas project id
const SCHEME = 'threads'; // app scheme
