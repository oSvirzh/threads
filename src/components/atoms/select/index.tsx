...
import { CaretDown } from '@/components/atoms/icons';
import type { InputControllerType } from '@/components/molecules/form-input';
import { useModal } from '@/components/organisms/modal/modal.component';
...
export const Index = (props: SelectProps) => {
  const {
    label,
    value,
    error,
